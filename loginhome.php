...
<body>
    ...
    <header>
        <nav>
            ...
            <a href="loginhome.php">Home <i class="bi bi-caret-down-fill"></i></a>
                <ul class="drop">
        ...
        <?php
            ...
            <img src="<?php echo "images/".$row['Images_And_Multimedia']; ?>" alt="Web Service 1">
               ...
               <div class="service-info">
                    ...
                    <p>Category:<?php echo $row['Article_Title']; ?></p>
                    <p>Publication Date:<?php echo $row['Publication_Date']; ?></p>
                    <!-- <a href="#">Learn More</a> -->
        ...
        <?php
            ...
            <div class="img-div"><img src="<?php echo "images\\".$row["Picture"];?>" alt="Web Service 1"></div>
                <div class="service-info1">
                    ...
                    <p class="p1"><?php echo $row['Info']?></p>
                    <!-- <a href="#">Learn More</a> -->
                    <form action="#" method="POST">
                        <input type="submit" name="morebtn" value="See More">
                    </form>
    ...
    <!-- Footer -->
    <footer>
        <p>&copy; 2024 Guardiansphere (SMC Ltd.). All rights reserved. | You are here: <a href="loginhome.php">Home</a></p>
